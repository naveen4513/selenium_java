...
public class UpdateOBPerformanceType extends TestSuiteBase {
	...
	public void UpdateOBPerformanceTypeTest (String obPerformanceType, String obPerformanceTypeOp, String obPerformanceTypeActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin OB Performance Type Update Test -- "+obPerformanceTypeOp);
		...
		if (!obPerformanceTypeOp.equalsIgnoreCase("")) {
			...
			driver.findElement(By.id("_name_id")).sendKeys(obPerformanceTypeOp.trim());
			}
		...
		} else if (obPerformanceTypeActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("OB Performance Type updated successfully, with Name -- " + obPerformanceTypeOp);
