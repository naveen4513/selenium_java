...
public class SupplierAuditLog extends TestSuiteBase {
	String result = null;
	...
	public void SupplierAuditLogTest (String Name, String Alias, String Tier, String Address, String ShareId, String Email, String TaxId, String ECCID,
	    ...
	    Logger.debug("Executing Test Case Supplier Audit Log with Name -- " + Name);
	    ...
	    String entityShowPageName = locateElementBy("supplier_create_page_name_textbox").getText();
	    ...
	    Logger.debug("Test Case Supplier Audit Log for -- " + Name + " -- is STARTED");
	    ...
	    Logger.debug("Test Case Supplier Audit Log for -- " + Name + " -- is PASSED");
        driver.get(CONFIG.getProperty("endUserURL"));
	    }
