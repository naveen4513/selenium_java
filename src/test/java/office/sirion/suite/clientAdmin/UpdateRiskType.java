...
public class UpdateRiskType extends TestSuiteBase {
	...
	public void UpdateRiskTypeTest (String riskType, String riskTypeOp, String riskTypeActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Risk Type Update Test -- "+riskTypeOp);
		...
		} else if (riskTypeActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("Risk Type updated successfully, with Name -- " + riskTypeOp);
