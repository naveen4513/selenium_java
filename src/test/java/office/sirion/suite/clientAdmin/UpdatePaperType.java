...
public class UpdatePaperType extends TestSuiteBase {
	...
	public void UpdatePaperTypeTest (String paperType, String paperTypeOp, String paperTypeActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Paper Type Update Test -- "+paperTypeOp);
		...
		} else if (paperTypeActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("Paper Type updated successfully, with Name -- " + paperTypeOp);
