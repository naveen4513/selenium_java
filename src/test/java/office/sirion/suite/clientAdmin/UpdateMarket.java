...
public class UpdateMarket extends TestSuiteBase {
	...
	public void UpdateMarketTest (String regionHub, String market, String marketOp, String marketGroup, String marketActive
		...
		Logger.debug("Executing Client Admin Market Update Test -- "+marketOp);
		...
		if (marketGroup.equalsIgnoreCase("Yes")) {
			...
			} else if (marketActive.equalsIgnoreCase("No")) {
				if (driver.findElement(By.id("_active_id")).isSelected())
					driver.findElement(By.id("_active_id")).click();
				}
        ...
        Logger.debug("Market updated successfully, with Name -- " + marketOp);
