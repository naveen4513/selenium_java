...
public class UpdateRegionHub extends TestSuiteBase {
	...
	public void UpdateRegionHubTest (String regionHub, String regionHubOp, String regionHubActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Region/Hub Update Test -- "+regionHubOp);
		...
		} else if (regionHubActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("Region/Hub updated successfully, with Name -- " + regionHubOp);
