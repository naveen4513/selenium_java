...
public class CompanyCode extends TestSuiteBase {
	...
	public void CompanyCodeCreation (String regionHub, String market, String internalContractingParty, String companyCode,
			String companyCodeOp, String companyCodeECCID, String companyCodeActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Company Code Creation Test -- "+companyCodeOp);
		...
		if (!companyCode.equalsIgnoreCase("")) {
            try {
                new Select(driver.findElement(By.id("_id_id"))).selectByVisibleText(companyCode.trim());
		...
		if (companyCode.equalsIgnoreCase("")) {
			...
			WebElement e = driver.findElement(By.cssSelector("div._id_idformError.parentFormmasterCompanyCode.formError"));
			...
			Logger.debug("Company Code is Mandatory");
		...
		if (companyCodeOp.equalsIgnoreCase("")) {
			...
			Assert.assertEquals(entityErrors, "This field is required");
			Logger.debug("Company Code Organization Preference is Mandatory");
		...
		if (companyCodeECCID.equalsIgnoreCase("")) {
			...
			WebElement e = driver.findElement(By.cssSelector("div._eccId_idformError.parentFormmasterCompanyCode.formError"));
			String entityErrors = e.findElement(By.className("formErrorContent")).getText();
        ...
        Logger.debug("Company Code created successfully, with Name -- " + companyCodeOp);
