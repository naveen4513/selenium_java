...
public class ToDoApprovalsContentControls extends TestSuiteBase {
	String result=null;
	...
	public void ToDoApprovalsContentControlsTest (String entityName, String entityRoleGroup, String entityStatusAll, String entityStatus,
			String entityPerformanceStatusAll, String entityPerformanceStatus
		...
		Logger.debug("Executing Tab To Do (Approvals) Content Controls Test for --- "+entityName);
		
		driver.get(CONFIG.getProperty("clientAdminURL"));
		fluentWaitMethod(driver.findElement(By.linkText("To Do (Approvals) Content Controls")));

		driver.findElement(By.linkText("To Do (Approvals) Content Controls")).click();
		fluentWaitMethod(driver.findElement(By.id("tabs-inner-sec")).findElement(By.className("tabs-inner-sec-content")));

		List<WebElement> entityList = driver.findElement(By.className("tabs-inner-sec-content")).findElements(By.className("entity"));
		Iterator<WebElement> itrEntityList = entityList.iterator();
		
		while (itrEntityList.hasNext()) {
			WebElement entityElement = itrEntityList.next();
			
			if (entityElement.findElement(By.className("tabs-inner-sec-header")).getText().equalsIgnoreCase(entityName)) {
				entityElement.findElement(By.className("tabs-inner-sec-content")).findElement(By.className("entityStakeholders"));
			}
		...
		if (entityRoleGroup.equalsIgnoreCase("Yes")) {
    		...
    		for (String entityData : entityStatus.split(";")) {
		...
		Logger.debug("Tab List Parameters updated successfully for --- " +entityName);
