...
public class DelegatedToMe extends TestSuiteBase {
	...
	public void DelegatedTo (String testCaseID)
	    ...
	    Logger.debug("Executing Test Case: Delegated To Me");
	    ...
	    //Click on the first entity id in delegated to me section
	    String delegatedToMe = driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[1]/ng-view[1]/div[1]/div[3]/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[4]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/a[1]")).getText();
	    driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[1]/ng-view[1]/div[1]/div[3]/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[4]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/a[1]")).click();
	    
	    String delegatedByMeSplit = delegatedToMe.substring(0,2);
	    ...
	    Assert.assertEquals(delegatedToMe, showPageId);
	    
	    Logger.debug("Delegated to me open succesfully for entity id -- " +delegatedToMe);
