...
public class Invoice extends TestSuiteBase {
    ...
    public void BulkActionInvoiceTest(String entitytitles, String obCurrentstate, String obNextState, String obActionToBePerformed,String obPrivacy, String obComments,
