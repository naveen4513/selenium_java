...
public class UpdateContractPaper extends TestSuiteBase {
	...
	public void UpdateContractPaperTest (String contractPaper, String contractPaperOp, String contractPaperActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Contract Paper Update Test -- "+contractPaperOp);
        ...
        Assertion(entityTypeShowPage, contractPaper+ "Contract Paper at show page is -- " +entityTypeShowPage+ " instead of -- " +contractPaper);
		...
		} else if (contractPaperActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("Contract Paper updated successfully, with Name -- " + contractPaperOp);
