...
public class UpdateSLCategory extends TestSuiteBase {
	...
	public void UpdateSLCategoryTest (String slCategory, String slCategoryOp, String slCategoryActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin SL Category Update Test -- "+slCategoryOp);
		...
		} else if (slCategoryActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("SL Category updated successfully, with Name -- " + slCategoryOp);
