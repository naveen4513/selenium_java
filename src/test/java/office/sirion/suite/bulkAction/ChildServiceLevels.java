...
public class ChildServiceLevels extends TestSuiteBase {
    ...
    public void BulkActionChildServiceLevelTest(String entitytitles, String obCurrentstate, String obNextState, String obActionToBePerformed,String obPrivacy, String obComments,
        ...
        //
        fluentWaitMethod(driver.findElement(By.id("rightLinks")).findElement(By.linkText("VIEW CHILD SERVICE LEVELS")));

        driver.findElement(By.id("rightLinks")).findElement(By.linkText("VIEW CHILD SERVICE LEVELS")).click();
        //
