...
public class UpdateBusinessLine extends TestSuiteBase {
	...
	public void UpdateBusinessLineTest (String businessLine, String businessLineOp, String businessLineActive
		...
		Logger.debug("Executing Test Client Admin Business Line Update for -- " + businessLineOp);
		...
		} else if (businessLineActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
		...
		Logger.debug("Test Client Admin Business Line Update for -- " + businessLineOp + " is PASSED");
        driver.get(CONFIG.getProperty("clientAdminURL"));
        }
