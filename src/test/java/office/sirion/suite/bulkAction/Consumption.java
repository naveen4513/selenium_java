...
public class Consumption extends TestSuiteBase {
    ...
    public void BulkActionConsumptionTest(String entitytitles, String obCurrentstate, String obNextState, String obActionToBePerformed,String obPrivacy, String obComments,
        ...
        //
        fluentWaitMethod(driver.findElement(By.id("rightLinks")).findElement(By.linkText("View Consumptions")));

        driver.findElement(By.id("rightLinks")).findElement(By.linkText("View Consumptions")).click();
        //
                ...
                for (String titles : entitytitles.split(";")) {
                    ...
                    if (!titles.equalsIgnoreCase("") && titles.length() <= 30) {
                        ...
                        try {
                            ...
                            Logger.debug("No Such Consumption is visible under listing page");
