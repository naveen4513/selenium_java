...
public class ClauseUpdate extends TestSuiteBase {
	String result = null;
	...
	public void ClauseUpdateTest (String testCaseID, String Name, String HeaderLabel, String SubHeader, String ClauseType, String Suppliers, String ContractingEntity,
	    ...
	    Logger.debug("Executing Test Case Clause Update with Name -- " + ParentEntity);
	    ...
	    //
		Logger.debug("Test Case CLAUSE Update with Title -- " + Name + " -- is STARTED");
		...
		if (locateElementBy("clause_create_page_name_textbox").findElement(By.tagName("span")).getText().equalsIgnoreCase("Name Must Be Unique")) {
		 ...
		 Logger.debug("Test Case CLAUSE Update with Title -- " + ParentEntity + " -- is PASSED");
		 driver.get(CONFIG.getProperty("endUserURL"));
		 }
