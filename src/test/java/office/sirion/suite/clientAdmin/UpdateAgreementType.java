...
public class UpdateAgreementType extends TestSuiteBase {
	...
	public void UpdateAgreementTypeTest (String agreementType, String agreementTypeOp, String agreementTypeActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Agreement Type Update Test -- "+agreementTypeOp);
		...
		} else if (agreementTypeActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("Agreement Type updated successfully, with Name -- " + agreementTypeOp);
