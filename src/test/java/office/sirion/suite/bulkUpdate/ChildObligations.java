...
public class ChildObligations extends TestSuiteBase {
    ...
    public void BulkUpdateChildObligationTest(String EntityName, String Sino, String BISupplier, String BIContract, String BITitle, String BIDescription, String BIPerformanceType,
                                         ...
                                         String Process) throws InterruptedException, IOException, TestLinkAPIException {
        ...
        eubcj.EndUserBulkUpdateChildObligationDownloadTemplateTest(EntityName);
        ...
        XLSUtils xls = new XLSUtils(System.getProperty("user.dir") + "/src/test/java/office/sirion/xls", "mcd-Child Obligation-Update.xlsm");

        if (xls.writeRowData("Obligation", 6, columnData) == true) {
            eubcj.EndUserBulkUpdateChildObligationUploadTemplateTest(xls.toString());

            EndUserBulkUpdateShowPageVerification EUBCSPV = new EndUserBulkUpdateShowPageVerification();
            EUBCSPV.EndUserBulkUpdateChildObligationTest("mcd-Child Obligation-Update.xlsm");
        }
    }
