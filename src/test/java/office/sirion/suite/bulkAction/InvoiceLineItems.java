...
public class InvoiceLineItems extends TestSuiteBase {
    ...
    public void BulkActionInvoiceLineItemTest(String entitytitles, String Currentstate, String NextState, String ActionToBePerformed,String Privacy, String Comments,
        ...
        //
        fluentWaitMethod(driver.findElement(By.id("rightLinks")).findElement(By.linkText("View Invoice Line Items")));

        driver.findElement(By.id("rightLinks")).findElement(By.linkText("View Invoice Line Items")).click();
        //
        ...
        try {
            addFieldValue("bulk_action_current_task_drop_down", Currentstate);
            if (!Currentstate.equalsIgnoreCase("")) {
                addFieldValue("bulk_action_next_task_drop_down", NextState);
            }
        ...
        try {
            ...
            if (ActionToBePerformed.equalsIgnoreCase("Y")) {
