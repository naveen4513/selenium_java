...
public class UpdateClauseCategory extends TestSuiteBase {
	...
	public void UpdateClauseCategoryTest (String clauseCategory, String clauseCategoryOp, String clauseCategoryActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Clause Category Update Test -- "+clauseCategoryOp);
		...
		} else if (clauseCategoryActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("Clause Category updated successfully, with Name -- " + clauseCategoryOp);
