...
public class UpdateSLSubCategory extends TestSuiteBase {
	...
	public void UpdateSLSubCategoryTest (String slCategory, String slSubCategory, String slSubCategoryOp, String slSubCategoryActive
		...
		Logger.debug("Executing Client Admin SL Sub-Category Update Test -- "+slSubCategoryOp);
...
*/
        ...
        String entityTypeParentShowPage = driver.findElement(By.id("_c_com_sirionlabs_model_MasterServiceCategory_clientpref_name_id")).getText();
        Assert.assertEquals(entityTypeParentShowPage, slSubCategoryOp, "SL Sub-Category Name at show page is -- " +entityTypeParentShowPage+ " instead of -- " +slSubCategoryOp);
		...
		if (slSubCategoryActive.equalsIgnoreCase("Yes")) {
			...
			} else if (slSubCategoryActive.equalsIgnoreCase("No")) {
				if (driver.findElement(By.id("_active_id")).isSelected())
					driver.findElement(By.id("_active_id")).click();
				}
        ...
        Logger.debug("SL Sub-Category updated successfully, with Name -- " + slSubCategoryOp);
