...
public class ContractTemplateUpdate extends TestSuiteBase {
	String result = null;
	...
	public void ContractTemplateUpdateTest (String testCaseID, String Name, String TemplateHeader, String TableOfContent, String TransactionTypes, String Suppliers,
	    ...
	    Logger.debug("Executing Test Case CONTRACT TEMPLATE Update with Name -- " + ParentEntity);
		...
		// CONTRACT TEMPLATE - EDIT PAGE - EDIT BUTTON
		...
		if (locateElementBy("contract_template_create_page_name_textbox").findElement(By.tagName("span")).getText().equalsIgnoreCase("Name Must Be Unique")) {
		 ...
		 Logger.debug("Executing Test Case CONTRACT TEMPLATE Update with Name -- " + Name + " -- is PASSED");
		 driver.get(CONFIG.getProperty("endUserURL"));
		 }
