...
public class ContractTemplateListingOpen extends TestSuiteBase {
	String result = null;
	...
	public void ContractTemplateListingOpenTest (
	    ...
	    Logger.debug("Executing Test Case Listing Page Open of CONTRACT TEMPLATE");
