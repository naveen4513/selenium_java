...
public class ServiceLevels extends TestSuiteBase {
    ...
    public void BulkActionObligationTest(String entitytitles, String obCurrentstate, String obNextState, String obActionToBePerformed,String obPrivacy, String obComments,
        ...
        Logger.debug("Executing Test Case Service Level Bulk creation with Titles -- " + entitytitles);
                ...
                for (String titles : entitytitles.split(";")) {
                    ...
                    if (!titles.equalsIgnoreCase("") && titles.length() <= 30) {
                        try {
                            ...
                            Logger.debug("No Such Service Level is visible under listing page");
