...
public class EntityShow extends TestSuiteBase {
	String result = null;
	String runmodes[] = null;
	static int count = -1;
	static boolean isTestPass = true;
	String testCaseID;
	String entityListingID = null;
	...
	public void EntityShow (String testCaseID, String entity) 
...
/*		locateElementBy("vh_quick_link").click();
   ...
   //   Assert.assertEquals(entityShowPageID, entityListingID);
		...
		if (driver.findElement(By.className("bulkUpdateActions")).getText().contains("Bulk Edit"))
			
		{
			entityListingID = driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[1]/ng-view[1]/div[3]/div[7]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/a")).getText();
		...
		{				
			entityListingID = driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[1]/ng-view[1]/div[3]/div[7]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[2]/table[1]/tbody[1]/tr[1]/td[1]/a")).getText();
		 driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[1]/ng-view[1]/div[3]/div[7]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[2]/table[1]/tbody[1]/tr[1]/td[1]/a")).click();
		}
        ...
        System.out.println("Show page open successfully for entity -- Supplier / Client -- " +entityListingID);
		}
		...
		// Opening PO show page
	    if (entity.equalsIgnoreCase("Purchase Order")) {
        ...
        Logger.debug("Show page open successfully for entity -- Purchase Order");
        System.out.println("Show page open successfully for entity -- Purchase Order -- " +entityListingID);  
	    }
