...
public class EndUserAttachmentSearch extends TestSuiteBase {
	String result = null;
	...
	public void EndUserAttachmentSearchTest (String EntityTypeName,String SearchText) throws InterruptedException {
		...
		Logger.debug("Executing Test Case issue Workflow with Name --- ");
		...
		addFieldValue("end_user_advance_search_drop_down","Attachments");
