...
public class CDRUpdate extends TestSuiteBase {
	String result = null;
	...
	public void CDRUpdateTest (String testCaseID, String cdrTitle, String cdrClientContractingEntity, String cdrCounterPartyContractingEntity, String cdrSuppliers,
...
//		addFieldValue("entity_create_page_actual_date", cdrActualDate.trim());
		...
		Assert.assertEquals(entityShowPageName, cdrTitle);

	    Logger.debug("Test Case CDR Update with Title -- " + cdrTitle + " -- PASSED");
	    driver.get(CONFIG.getProperty("endUserURL"));
	    }
