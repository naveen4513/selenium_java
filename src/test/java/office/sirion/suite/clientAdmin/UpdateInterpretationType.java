...
public class UpdateInterpretationType extends TestSuiteBase {
	...
	public void UpdateInterpretationTypeTest (String interpretationType, String interpretationTypeOp, String interpretationTypeActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Interpretation Type Update Test -- "+interpretationTypeOp);
		...
		} else if (interpretationTypeActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        Logger.debug("Interpretation Type updated successfully, with Name -- " + interpretationTypeOp);
