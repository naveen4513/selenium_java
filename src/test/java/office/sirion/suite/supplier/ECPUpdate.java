...
public class ECPUpdate extends TestSuiteBase {
	String result = null;
	...
	public void ECPUpdateTest (String Name, String ECCID, String SapSourcingID, String DUNSID, String VendorRegistrationNumber, String Replicated,
	    ...
	    Logger.debug("Executing Test Case ECP Update for -- " + ParentEntity);
        ...
        try {
            driver.findElement(By.xpath("//*[@id='table_3609']/tbody/tr[1]/td[1]/a")).click();
        }catch (Exception e){
            System.out.println("No ECP available, hence returing from test-case");
            return;
        }
		...
		Logger.debug("Test Case ECP Update for -- " + Name + " -- is PASSED");
        driver.get(CONFIG.getProperty("endUserURL"));
	    }
