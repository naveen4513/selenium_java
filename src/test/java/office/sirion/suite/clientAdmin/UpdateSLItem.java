...
public class UpdateSLItem extends TestSuiteBase {
	...
	public void UpdateSLItemTest (String slCategory, String slSubCategory, String slItem, String slItemOp, String slItemActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin SL Item Update Test -- "+slItemOp);
...
*/
        ...
        String entityTypeParentParentShowPage = driver.findElement(By.id("_c_com_sirionlabs_model_masterslaitem_systemSLAItem.name_id")).getText();
        Assert.assertEquals(entityTypeParentParentShowPage, slItemOp, "SL Item Name at show page is -- " +entityTypeParentParentShowPage+ " instead of -- " +slItemOp);
		...
		if (slItemActive.equalsIgnoreCase("Yes")) {
			...
			} else if (slItemActive.equalsIgnoreCase("No")) {
				if (driver.findElement(By.id("_active_id")).isSelected())
					driver.findElement(By.id("_active_id")).click();
				}
        ...
        Logger.debug("SL Item updated successfully, with Name -- " + slItemOp);
