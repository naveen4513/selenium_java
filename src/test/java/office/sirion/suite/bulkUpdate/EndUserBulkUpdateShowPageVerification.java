...
public class EndUserBulkUpdateShowPageVerification extends TestSuiteBase {

    static List<String> successrows = null;

    public void EndUserBulkUpdateObligationTest(String Uploadedfile) throws InterruptedException {
    ...
    public void EndUserBulkUpdateChildObligationTest(String Uploadedfile) throws InterruptedException {
    ...
    public void EndUserBulkUpdateDisputeTest(String Uploadedfile) throws InterruptedException {
    ...
    public void EndUserBulkUpdateChildServiceLevelTest(String Uploadedfile) throws InterruptedException {
