...
public class UpdateServiceSubCategory extends TestSuiteBase {
	...
	public void UpdateServiceSubCategoryTest (String serviceCategory, String serviceSubCategory, String serviceSubCategoryOp, String serviceSubCategoryActive
		...
		Logger.debug("Executing Client Admin Service Sub-Category Update Test -- "+serviceSubCategoryOp);
        ...
        String entityTypeParentShowPage = driver.findElement(By.id("_c_com_sirionlabs_model_MasterServiceSubCategory_systemServiceSubCategory.name_id")).getText();
        Assert.assertEquals(entityTypeParentShowPage, serviceSubCategory, "Service Sub-Category Name at show page is -- " +entityTypeParentShowPage+ " instead of -- " +serviceSubCategory);
		...
		if (serviceSubCategoryActive.equalsIgnoreCase("Yes")) {
			...
			} else if (serviceSubCategoryActive.equalsIgnoreCase("No")) {
				if (driver.findElement(By.id("_active_id")).isSelected())
					driver.findElement(By.id("_active_id")).click();
				}
        ...
        String entityTypeUpdateShowPage = driver.findElement(By.id("_s_com_sirionlabs_model_MasterServiceSubCategory_clientpref_name_id")).getText();
        Assert.assertEquals(entityTypeUpdateShowPage, serviceSubCategoryOp, "Service Sub-Category Name at show page is -- " +entityTypeUpdateShowPage+ " instead of -- " +serviceSubCategoryOp);

        Logger.debug("Service Sub-Category updated successfully, with Name -- " + serviceSubCategoryOp);
