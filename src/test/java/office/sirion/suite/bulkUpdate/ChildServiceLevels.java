...
public class ChildServiceLevels extends TestSuiteBase {
    ...
    public void BulkUpdateChildServiceLevelsTest(String EntityName, String Sino,String ID,String BIDuplicaterecordsallowed,String PerformanceSupplierNumerator,String PerformanceActualNumerator,
                                                 String PerformanceSupplierDenominator,String PerformanceActualDenominator,String PerformanceSupplierCalculation,String PerformanceActualPerformance,
                                                 String PerformanceDiscrepancy,String PerformanceDiscrepancyResolutionStatus,String PerformanceFinalNumerator,String PerformanceFinalDenominator,
                                                 String PerformanceFinalPerformance,String PerformanceSLMet,String CAPrivacy,String CAComments,String CAActualDate,String CARequestedBy,
                                                 String CAChangeRequest,String Process) throws InterruptedException, IOException, TestLinkAPIException {
        ...
        eubcj.EndUserBulkUpdateChildServiceLevelDownloadTemplateTest(EntityName);
        ...
        XLSUtils xls = new XLSUtils(System.getProperty("user.dir") + "/src/test/java/office/sirion/xls", "mcd-Child Service Level-Update.xlsm");

        if (xls.writeRowData("Obligation", 6, columnData) == true) {
            eubcj.EndUserBulkUpdateChildServiceLevelUploadTemplateTest(xls.toString());

            EndUserBulkUpdateShowPageVerification EUBUSPV = new EndUserBulkUpdateShowPageVerification();
            EUBUSPV.EndUserBulkUpdateChildServiceLevelTest("mcd-Child Service Level-Update.xlsm");
        }
    }
