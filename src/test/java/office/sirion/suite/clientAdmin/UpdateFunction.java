...
public class UpdateFunction extends TestSuiteBase {
	...
	public void UpdateFunctionTest (String function, String functionOp, String functionAlias, String functionActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Function Update Test -- "+functionOp);
		...
		} else if (functionActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
        ...
        String entityTypeUpdateShowPage = driver.findElement(By.id("_c_com_sirionlabs_model_MasterContractType_systemContractType.name_id")).getText();
        Assert.assertEquals(entityTypeUpdateShowPage, function, "Function at show page is -- " +entityTypeUpdateShowPage+ " instead of -- " +function);

        Logger.debug("Function updated successfully, with Name -- " + functionOp + " and Alias --- " + functionAlias);
