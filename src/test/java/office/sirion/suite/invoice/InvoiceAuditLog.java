...
public class InvoiceAuditLog extends TestSuiteBase {
	String result = null;
	...
	public void InvoiceAuditLogTest (String InvoiceNumber, String Title, String PONumber, String Currency, String TimeZone, String ContractingEntity,
	    ...
	    Logger.debug("Executing Test Case Invoice AuditLog for -- " + Title);
	    ...
	    addFieldValue("inv_create_page_invoice_period_start_date", InvoicePeriodStart.trim());

	    addFieldValue("inv_create_page_invoice_period_end_date", InvoicePeriodEnd.trim());

	    addFieldValue("inv_create_page_credit_period_in_days_numeric", CreditPeriodindays.trim());

	    addFieldValue("inv_create_page_invoice_date", InvoiceDate.trim());

	    addFieldValue("inv_create_page_payment_term_numeric", PaymentTerm.trim());

	    addFieldValue("inv_create_page_expected_receipt_date", ExpectedReceiptDate.trim());

	    addFieldValue("inv_create_page_system_receipt_date", SystemReceiptDate.trim());

	    addFieldValue("inv_create_page_payment_due_date", PaymentDueDate.trim());

	    addFieldValue("inv_create_page_actual_payment_date", ActualPaymentDate.trim());

	    addFieldValue("inv_create_page_actual_receipt_date", ActualReceiptDate.trim());
	    ...
	    Logger.debug("Test Case Invoice AuditLog with Title -- " + Title + " -- is STARTED");

	    WebElement elementOddRowSelected = driver.findElement(By.id("table_622")).findElements(By.className("odd")).get(0);
	    ...
	    Logger.debug("Test Case Invoice Audit Log for -- " + Title + " -- is PASSED");
        driver.get(CONFIG.getProperty("endUserURL"));
	    }
