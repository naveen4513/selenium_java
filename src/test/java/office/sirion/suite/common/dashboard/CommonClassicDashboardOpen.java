...
public class CommonClassicDashboardOpen extends TestSuiteBase {
	String result = null;
	...
	public void CommonClassicDashboardOpenTest (
	    ...
	    Logger.debug("Executing Test Case Classic Dashboard Open --- ");
	    ...
	    fluentWaitMethod(driver.findElement(By.className("Csupplier1")));
	    driver.findElement(By.className("Csupplier1")).click();
	    fluentWaitMethod(driver.findElement(By.cssSelector("div.rtChartContainer.ng-scope")));

	    new Actions(driver).moveToElement(driver.findElement(By.className("Cconfigure1"))).clickAndHold().build().perform();
	    driver.findElement(By.className("drop-box")).findElement(By.id("PriorityLink")).click();
		Thread.sleep(2000);
		...
		while (itrchartListID.hasNext()) {
		    ...
		    Logger.debug("Test Case Classic Dashboard Open For --- " + selectedDashboardName.toUpperCase() + " --- is Completed Successfully");
		    ...
		    if (CONFIG.getProperty("dashboardDownload").equalsIgnoreCase("Yes")) {
			    if (driver.findElement(By.className("c-subHead")).findElements(By.className("moreOptions")).size()!=0) {
	    			...
	    			if (fileSrc.exists()) {
		    			File destFolder = new File(System.getProperty("user.dir")+"//Downloaded Data//"+new SimpleDateFormat("dd_MMMM_yyyy").format(Calendar.getInstance().getTime()).toString() + "//Common Dashboards//Classic Dashboard");
	    		    ...
	    		    Logger.debug("Test Case Classic Dashboard Download Graph For --- " + selectedDashboardName.toUpperCase() + " --- is Completed Successfully");
	    			...
	    			if (fileExcelSrc.exists()) {
		    			...
		    			try {
		    				...
		    				inputstream.close();
			    		    Logger.debug("Test Case Classic Dashboard Download Graph With Data For --- " + selectedDashboardName.toUpperCase() + " --- is Completed Successfully");
			    		    } catch (Exception e) {
			    				Logger.error(e.getMessage());
			    				}
		    			}
	    			else {
		    		    Logger.error("Test Case Classic Dashboard Download Graph With Data For --- " + selectedDashboardName.toUpperCase() + " --- is Completed Unsuccessfully");	    				
	    			}
			    }
		    }
	    ...
	    Logger.debug("Test Case Classic Dashboard Open is Completed Successfully--- ");
        driver.get(CONFIG.getProperty("endUserURL"));
	    }
