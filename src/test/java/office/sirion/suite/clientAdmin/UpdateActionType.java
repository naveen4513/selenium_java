...
public class UpdateActionType extends TestSuiteBase {
	...
	public void UpdateActionTypeTest (String actionType, String actionTypeOp, String actionTypeActive
		...
		Logger.debug("Executing Test Client Admin Action Type Update for -- " + actionTypeOp);
		...
		} else if (actionTypeActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
		...
		Logger.debug("Test Client Admin Action Type Update for -- " + actionTypeOp + " is PASSED");
        driver.get(CONFIG.getProperty("clientAdminURL"));
        }
