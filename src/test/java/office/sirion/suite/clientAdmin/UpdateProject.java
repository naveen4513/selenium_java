...
public class UpdateProject extends TestSuiteBase {
	...
	public void UpdateProjectTest (String projectName, String projectNameUpdate, String projectCurrency, String projectStartDate, String projectEndDate,
			String projectTotalCost, String projectOriginalCost, String projectActive) throws InterruptedException {
		count++;
		...
		Logger.debug("Executing Client Admin Project Update Test -- "+projectName);
		...
		if (!projectNameUpdate.equalsIgnoreCase("")) {
			driver.findElement(By.id("_name_id")).clear();
			driver.findElement(By.id("_name_id")).sendKeys(projectNameUpdate.trim());
			}
		...
		} else if (projectActive.equalsIgnoreCase("No")) {
			if (driver.findElement(By.id("_active_id")).isSelected())
				driver.findElement(By.id("_active_id")).click();
		}
		...
		if (projectNameUpdate.length() > 128) {
			fail = true;
        ...
        String entityTypeUpdateShowPage = driver.findElement(By.id("_s_com_sirionlabs_model_MasterProject_name_name_id")).getText();
        Assert.assertEquals(entityTypeUpdateShowPage, projectName, "Project Name at show page is -- " +entityTypeUpdateShowPage+ " instead of -- " +projectName);

        Logger.debug("Project updated successfully, with Name -- " + projectNameUpdate);
