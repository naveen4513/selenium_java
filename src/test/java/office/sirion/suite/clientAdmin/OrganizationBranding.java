...
public class OrganizationBranding extends TestSuiteBase {
	...
	public void OrganizationBrandingTest () throws InterruptedException {
		...
		Logger.debug("Executing Client Admin Organization Branding Test -- Organization Branding");
		
		driver.get(CONFIG.getProperty("clientAdminURL"));
		fluentWaitMethod(driver.findElement(By.linkText("Organization Branding")));

		driver.findElement(By.linkText("Organization Branding")).click();
		//

		if (!driver.findElement(By.id("_modernListingView_id")).isSelected())
