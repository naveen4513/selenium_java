...
public class OBUpdate extends TestSuiteBase {
	String result = null;
	...
	public void OBUpdateTest (String obTitle, String obDescription, String obPerformanceType, String obCategory, String obSubCategory,
	    ...
	    Logger.debug("Executing Test Case Obligation Update with Title -- " + obTitle + " under Obligation Parent -- " + obParent);
	    ...
	    Logger.debug("Test Case Obligation Update with Title -- " + entityShowPageName + " -- is PASSED");
        driver.get(CONFIG.getProperty("endUserURL"));
	    }
